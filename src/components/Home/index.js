...
function Home() {
  return (
    <section>
      ...
      <h3>Your team isn't bad... You just need the right stats</h3>
      <iframe src="https://giphy.com/embed/rhaIsgMSRHaUg" width="800" height="600" frameBorder="0" class="giphy-embed"></iframe><p><a href="https://giphy.com/gifs/tvland-football-touchdown-rudy-huxtable-rhaIsgMSRHaUg"></a></p>
      </div>
    </section>
  );
};
